        ...
        <div className="px-4 py-6 sm:px-0">
          <div className="bg-white dark:bg-plum-900 overflow-hidden shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6 text-center">
              ...
              <h2 className="text-2xl font-bold text-plum-900 dark:text-plum-100 mb-4">
                Acceso Denegado
              </h2>
              
              <p className="text-lg text-plum-700 dark:text-plum-300 mb-6">
                Lo sentimos, tu solicitud de acceso ha sido rechazada.
              </p>

              {/* Rejection details */}
              <div className="bg-red-50 rounded-lg p-6 mb-6">
                <h3 className="text-lg font-medium text-plum-900 dark:text-plum-100 mb-3">
                  Detalles del rechazo
                </h3>
                
                {user.rejectionReason ? (
                  <div className="bg-white dark:bg-plum-900 rounded p-4 mb-4">
                    <p className="text-sm text-plum-800 dark:text-plum-200">
                      <strong>Razón:</strong> {user.rejectionReason}
                    </p>
                  </div>
                ) : (
                  <p className="text-sm text-plum-700 dark:text-plum-300 mb-4">
              ...
              {/* User info */}
              <div className="bg-plum-50 dark:bg-plum-950 rounded-lg p-4 mb-6">
                <h3 className="text-sm font-medium text-plum-900 dark:text-plum-100 mb-2">
                  Información de tu solicitud
                </h3>
                <dl className="grid grid-cols-1 gap-x-4 gap-y-2 sm:grid-cols-2 text-sm">
                  <div>
                    <dt className="text-plum-600 dark:text-plum-400">Email:</dt>
                    <dd className="text-plum-900 dark:text-plum-100">{user.email}</dd>
                  </div>
                  <div>
                    <dt className="text-plum-600 dark:text-plum-400">Tipo de usuario solicitado:</dt>
                    <dd className="text-plum-900 dark:text-plum-100">{userType?.displayName || 'Cargando...'}</dd>
                  </div>
                  <div>
                    <dt className="text-plum-600 dark:text-plum-400">Fecha de solicitud:</dt>
                    <dd className="text-plum-900 dark:text-plum-100">
                  ...
                  <div>
                    <dt className="text-plum-600 dark:text-plum-400">Fecha de rechazo:</dt>
                    <dd className="text-plum-900 dark:text-plum-100">
                  ...
                  <div className="sm:col-span-2">
                    <dt className="text-plum-600 dark:text-plum-400">Revisado por:</dt>
                    <dd className="text-plum-900 dark:text-plum-100">{user.rejectedBy || 'Administrador del sistema'}</dd>
                  </div>
                </dl>
              </div>
