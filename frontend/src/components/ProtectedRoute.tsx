    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-plum-50 dark:bg-plum-950">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-fresh-600 mx-auto"></div>
          <p className="mt-4 text-plum-700 dark:text-plum-300">Verificando permisos...</p>
        </div>
      </div>
    );
  }
